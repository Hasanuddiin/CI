...
<nav class="navbar navbar-default navbir" role="navigation" style="margin-bottom: 0px;border-radius: 0;background: #737373;border: 0">
    <div class="navbar-header">
        <a class="navbar-brand " href="index.html" style="color: white">Kependudukan</a>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="<?php echo site_url('dtlp');?>"><i class="fa fa-briefcase fa-fw"></i> Data Penduduk</a>
                </li>
                <li>
                    <a href="<?php echo site_url('years')?>"><i class="fa fa-calendar fa-fw"></i> Data Hub. Keluarga</a>
                </li>
                <!--<li>
